...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/art/Documents/eatMe_v1/.claude/.gsd-surface.json`
(sibling to `/home/art/Documents/eatMe_v1/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/art/Documents/eatMe_v1/.claude/skills/gsd-*/`.
...
(`/home/art/Documents/eatMe_v1/.claude`), NOT the skills sub-directory (`/home/art/Documents/eatMe_v1/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/art/Documents/eatMe_v1/.claude` as `configDir`. The skill dirs themselves live at
`/home/art/Documents/eatMe_v1/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/art/Documents/eatMe_v1/.claude}"
SCOPE="global"
...
(i.e. `/home/art/Documents/eatMe_v1/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/art/Documents/eatMe_v1/.claude/.gsd-surface.json`
Install profile marker: `/home/art/Documents/eatMe_v1/.claude/.gsd-profile`
Skill dirs: `/home/art/Documents/eatMe_v1/.claude/skills/gsd-*/`
Engine module: `/home/art/Documents/eatMe_v1/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/art/Documents/eatMe_v1/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
