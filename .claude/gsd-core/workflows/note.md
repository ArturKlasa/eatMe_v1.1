...
- **Global scope**: `/home/art/Documents/eatMe_v1/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/art/Documents/eatMe_v1/.claude/notes/`)
...
2. Glob `/home/art/Documents/eatMe_v1/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/art/Documents/eatMe_v1/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/art/Documents/eatMe_v1/.claude/notes/` — works in any directory
