...
```
Agent(
  prompt="Read /home/art/Documents/eatMe_v1/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/art/Documents/eatMe_v1/.claude/gsd-core/templates/VALIDATION.md`
