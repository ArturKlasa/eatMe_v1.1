...
| 260629-pad | Ponytail-audit dead-code batch (F1,F2,F3,F5,F6 + F4 comment): drop unused v1 form-validation schemas (dishSchema/menuSchema/restaurantDataSchema + FormData types, encoded dropped migration-163 model), 7 unused i18nUtils exports, constants/pricing.ts, CUISINES alias, dead api.baseUrl env config; soften overpromising Result<T> comment. Grep-verified, no behavior change | 2026-06-29 | 9ac2d1d | [260629-pad-ponytail-audit-dead-code-batch](./quick/260629-pad-ponytail-audit-dead-code-batch/) |
| 260630-fcd | Ponytail-audit dead-code batch: delete 9 mobile 0-importer files (FilterComponents v1 filter UI, FilterFAB/QuickFilterModal, common ScreenLayout/SettingItem/EmptyState/FeatureList/SectionContainer, map/MapHeader, utils/spiceUtils) + drop @react-native-community/slider native dep; remove orphan packages/ui/styles/globals.css indirection. Held: BasicInfoForm (on-ice v2), currencyConfig shim (12-edit churn). Grep-verified, tsc passes, no behavior change | 2026-06-30 | 6f4f364, bee1fc7 | [260630-fcd-delete-dead-code-mobile-filter-ui-common](./quick/260630-fcd-delete-dead-code-mobile-filter-ui-common/) |
