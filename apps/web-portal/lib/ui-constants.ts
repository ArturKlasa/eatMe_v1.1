...
// -- Ingredient family colours ----------------------------------------------
// Migrated from /app/admin/ingredients/page.tsx FAMILY_COLOURS
...
// -- Dietary tag colours ----------------------------------------------------
// Migrated from components/DietaryTagBadges.tsx getCategoryColor
// Includes border class to match existing usage pattern.
...
export const DIETARY_TAG_COLOR_DEFAULT =
...
// -- Spice level config -----------------------------------------------------
// Consolidated from lib/constants.ts — kept in sync.
