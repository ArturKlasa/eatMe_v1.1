-- 162_REVERSE_ONLY_restaurant_needs_redo.sql
-- Reverses 162_restaurant_needs_redo.sql: restores the migration-129 version
-- of get_admin_restaurants and drops the flag column (flag values are lost).

DROP FUNCTION IF EXISTS get_admin_restaurants(text, text, boolean, text, boolean, int, int);
...
ALTER TABLE public.restaurants DROP COLUMN IF EXISTS needs_redo;
