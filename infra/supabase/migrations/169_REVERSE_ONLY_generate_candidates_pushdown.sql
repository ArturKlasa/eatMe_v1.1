-- ══════════════════════════════════════════════════════════════════════════════
-- REVERSE of migration 169 — restore the migration-167 generate_candidates.
--
-- Recreates the dish_modifiers-CTE form VERBATIM from migration 167. The arg
-- signature and 32-column return shape are unchanged between 167 and 169, so this
-- is a plain CREATE OR REPLACE (no DROP needed). Reverting reintroduces the §S9
-- whole-table modifier aggregate and its stale-stats statement-timeout exposure.
-- ══════════════════════════════════════════════════════════════════════════════
